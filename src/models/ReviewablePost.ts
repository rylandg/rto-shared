...
import { fixOptionals, optional, Nullable } from '../optional';
...
export const ReviewerV = fixOptionals(t.type({
  user_id: t.union([t.string, Nullable]),
  display_name: t.union([t.string, Nullable]),
  photo_url: t.union([t.string, Nullable]),
